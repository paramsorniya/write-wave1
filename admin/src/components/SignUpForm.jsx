import { Button, Group, TextInput, useMantineColorScheme, Loader } from "@mantine/core";
...
const SignUpForm = ({ toast, isSignin, setIsSignin, toggle, setFormClose }) => {
  ...
  useEffect(() => {
    if (file) {
      ...
      uploadFile(setFileURL, file, setLoading);  // Pass setLoading to manage the loader state
    }
  }, [file]);
    ...
    >
      ...
      <Group className={`w-full flex  justify-between`} mt='md'>
        <div className={`flex flex-col items-center justify-between`}>
          ...
          {loading && <Loader size="sm" color="blue" className='mt-2' />}  {/* Show loader while uploading */}
        </div>
