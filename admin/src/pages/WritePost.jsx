...
import { createSlug, uploadFile, uploadFile1 } from "../utils";
...
const WritePost = () => {
  ...
  // useEffect(() => {
  //   file && uploadFile1(setFileURL, file);
  // }, [file]);

  useEffect(() => {
    if (file) {
      setLoading(true); // Start loading when file upload begins
      uploadFile1(setFileURL, file, setLoading); // Pass setLoading to control loading state
    }
  }, [file]);
  return (
    <>
